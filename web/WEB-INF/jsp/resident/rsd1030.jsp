<html>
<head>
<meta name="selection" content="rsd1030"/>
 ...
 */
function bindEvent() {
    $(".rsd1030-search-btn").each(function(index, element) {
					...
					<div class="x_content">
						...
						<div class="form-group">
							...
							<a href="#" class="btn btn-primary btn-sm pull-right rsd1010-add-btn">추가</a>
							 -->
							<a href="#" class="btn btn-primary btn-sm pull-right rsd1030-search-btn">검색</a>
						</div>
