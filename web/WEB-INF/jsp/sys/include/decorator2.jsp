	...
	<body>
  		<div id="wrap">
				...
				<div id="gnb_blank">
					<ul class="topmenu" id="topmenu" name="topmenu">
						<li class="topmenu menu1">
							<a href="#" onclick="test(1);">
								<img src="/images/menu/top_menu01.png" />고객
							</a>
						</li>
						<li class="topmenu menu2"><a href="#" onclick="test(2);"><img src="/images/menu/top_menu02.png" />여신</a></li>
						<li class="topmenu menu3"><a href="#" onclick="test(3);"><img src="/images/menu/top_menu03.png" />ERP</a></li>
						<li class="topmenu menu4"><a href="#" onclick="test(4);"><img src="/images/menu/top_menu04.png" />회계</a></li>
	  		...
	  		<div id="leftmenu">
				...
				<div id="left4">
					<div id="leftmenu_title">ERP(회계)</div>
					<div>
						<ul class="leftmenu" id="leftmenu" name="leftmenu">
							<div class="submenu10">
								<p><a href="#">- 회계</a></p>
								<div class="panel10">
									<li><a href="/acc/accAcc/acco0010">일마감</a></li>
									<li><a href="/acc/accAcc/acco4010">전표총괄표</a></li>
									<li><a href="/acc/accAcc/acco4020">대차대조표</a></li>
									<li><a href="/acc/accAcc/acco4030">손익계산서</a></li>
									<li><a href="/acc/accAcc/acco4040">일일거래명세서</a></li>
									<li><a href="/acc/accAcc/acco4050">대체전표</a></li>
								</div>
							</div>
						</ul>
					</div>
